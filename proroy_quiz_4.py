...
mode = input("Enter calculation choice (min, max, avg): ")
count = int(input("Enter the number of values: "))
values = []

# Read values from the inputs of the user
...
# When the mode is invalid
    ...
    print("Invalid mode! Please select other calculation choice")
